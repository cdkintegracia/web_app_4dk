...
start_2024 = datetime(2024, 1, 1).strftime('%d.%m.%Y')
end_2025 = datetime(2025, 12, 31).strftime('%d.%m.%Y')
...
def get_service_list_elements() -> list:
    elements = b.get_all('lists.element.get', {'IBLOCK_TYPE_ID': 'lists', 'IBLOCK_ID': '169','filter': {'>=PROPERTY_1287': start_2024,
    '<=PROPERTY_1287': end_2025}})
