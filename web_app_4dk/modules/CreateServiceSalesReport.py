...
service_deal_current_month = ['Контрагент', 'Контрагент в договоре', 'Линк', 'МДЛП', 'Старт ЭДО', 'Кабинет сотрудника']
service_deal_values = {'Контрагент': 4800, 'Контрагент в договоре': 4800, 'Кабинет сотрудника': None, 'Линк': None, 'МДЛП': None, '1Спарк 3000': 3000,
