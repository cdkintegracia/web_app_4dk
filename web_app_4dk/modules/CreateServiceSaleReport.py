...
titles_for_sorting = []
month_names = ['Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь']
month_number = {
    'Январь': '01',
    'Февраль': '02',
    'Март': '03',
...
def create_report_service_sales():
    ...
    filenames = ['DEAL_20220731_6d490055_62e6c5642f727TONIGHT.xlsx', 'DEAL_20220831_66154768_630ef62fa45bb.xlsx', '300920222.xlsx', 'DEAL_20221031_d0ba71b5_635f5c9e736a7.xlsx', 'DEAL_20221130_a67f2b14_6386e8c656b60.xlsx']
    file_months = {'DEAL_20220731_6d490055_62e6c5642f727TONIGHT.xlsx': 'Июль', 'DEAL_20220831_66154768_630ef62fa45bb.xlsx': 'Август', '300920222.xlsx': 'Сентябрь', 'DEAL_20221031_d0ba71b5_635f5c9e736a7.xlsx': 'Октябрь', 'DEAL_20221130_a67f2b14_6386e8c656b60.xlsx': 'Ноябрь'}
    ...
    month_titles = ['Сотрудник', 'Подразделение', 'Июль ИТС', 'Июль Сервисы', 'Август ИТС', 'Август Сервисы', 'Сентябрь ИТС', 'Сентябрь Сервисы', 'Октябрь ИТС', 'Октябрь Сервисы', 'Ноябрь ИТС', 'Ноябрь Сервисы']
    service_titles = ['Подразделение', 'ФИО', 'Сервис', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Сумма']
