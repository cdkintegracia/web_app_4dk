...
service_deal_values = {'Контрагент': 5800, 'Кабинет сотрудника': None, 'Линк': None, 'МДЛП': None, '1Спарк 3000': 3000, '1Спарк': 3600,
                       '1СпаркПЛЮС 22500': 22500, '1СпаркПЛЮС': 25500,  'Спарк сумма': None, 'Старт ЭДО': 3000, 'Подпись': 0, 'Подпись 1000': 1000, 'РПД': None,
                       'ЭТП': None, '1СПАРК Риски': 3600, '1Спарк в договоре': 3600, 'Кабинет садовода': 1000, 'ЭДО': None, 'mag1c': 5100, '1С-Администратор': 17500}
